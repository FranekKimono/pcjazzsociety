...
useSeoMeta({
  ...
  description:
    page.value?.description || "The requested page could not be found",
});
...
<template>
  ...
  >
    <div class="text-center max-w-md">
      <h1 class="text-4xl font-bold text-primary-50 dark:text-primary-50 mb-4">
        Page Not Found
      </h1>
      <p class="text-zinc-100 dark:text-zinc-100 mb-6">
        Sorry, we couldn't find the page you're looking for.
      </p>
      <p class="text-zinc-100 dark:text-zinc-100 text-sm mb-8">
